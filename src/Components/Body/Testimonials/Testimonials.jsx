        ...
        <section className="py-4 md:py-6 lg:py-8  ">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <h4 className='text-3xl md:text-4xl lg:text-5xl max-w-[477.25px] mx-auto  font-medium mb-4'>
                    Look at what people say about us
                    </h4>
                    <p className='text-base md:text-lg lg:text-xl mb-4 max-w-[562.047px] mx-auto'>
