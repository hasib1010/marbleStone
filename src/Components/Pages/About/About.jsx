    ...
    <div className='bg-[#FAFAFB] p-4 lg:p-0'>
      ...
      <div className='container mx-auto'>
        <div className='flex lg:flex-row md:flex-col flex-col items-center justify-center'>
          <h2 className='lg:text-7xl md:text-3xl text-2xl font-medium max-w-[613px]'>
          ...
          <div className='ml-8'>
            ...
            <div className='flex lg:gap-4 justify-evenly md:justify-evenly lg:justify-start'>
              <button
                ...
                className={`px-4 py-2 text-base font-medium rounded-full flex items-center gap-3 transition-transform transform ${activeButton === 'cta1' ? 'bg-[#990A05] text-white hover:bg-[#d72d2a] scale-105' : 'text-black border border-[#990A05] hover:bg-[#f7d3d3] hover:text-[#990A05]'}`}
              >
                Our Vision
                {activeButton === "cta1" ? (
              ...
              <button
                ...
                className={`px-4 py-2 text-base font-medium rounded-full flex items-center gap-3 transition-transform transform ${activeButton === 'cta2' ? 'bg-[#990A05] text-white hover:bg-[#d72d2a] scale-105' : 'text-black border border-[#990A05] hover:bg-[#f7d3d3] hover:text-[#990A05]'}`}
              >
                Our History
                {activeButton === "cta2" ? (
                  <FaArrowRight className='bg-white text-black rounded-full p-[3px] text-xl' />
